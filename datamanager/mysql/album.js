...
exports.add_photo = function (photo_data, path_to_photo, callback) {
    var base_fn = photo_data.filename;
    var write_succeeded = false;
    var dbc;
    ...
    async.waterfall([
        ...
        function (dbclient, cb) {
            ...
            dbc.query(
                ...
                [ photo_data.albumid, base_fn, photo_data.description, photo_data.date, save_path ],
                backhelp.mscb(cb));
        },
...
function invalid_album_name() {
    return backhelp.error("invalid_album_name", "Album names can have letters, #s, _ and, -");
}
function invalid_filename() {
    return backhelp.error("invalid_filename", "Filenames can have letters, #s, _ and, -");
}
