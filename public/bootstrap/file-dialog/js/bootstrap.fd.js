!function(e) {
    ...
    e.FileDialog = function(a) {
        var o = e.extend(e.FileDialog.defaults, a), t = e(["<div class='modal fade'>", "    <div class='modal-dialog'>", "        <div class='modal-content'>", "            <div class='modal-header'>", "                <button type='button' class='close' data-dismiss='modal'>", "                    <span aria-hidden='true'>&times;</span>", "                    <span class='sr-only'>", o.cancelButton, "                    </span>", "                </button>", "                <h4 class='modal-title'>", o.title, "                </h4>", "            </div>", "            <div class='modal-body'>", "                <input type='file' />", "                <div class='bfd-dropfield'>", "                    <div class='bfd-dropfield-inner'>", o.dragMessage, "                    </div>", "                </div>", "                <div class='container-fluid bfd-files'>", "                </div>", "            </div>", "            <div class='modal-footer'>", "                <button type='button' class='btn btn-primary bfd-ok'>", o.okButton, "                </button>", "                <button type='button' class='btn btn-default bfd-cancel'", "                                data-dismiss='modal'>", o.cancelButton, "                </button>", "            </div>", "        </div>", "    </div>", "</div>"].join("")), n = !1, i = e("input:file", t), r = e(".bfd-dropfield", t), s = e(".bfd-dropfield-inner", r);
        s.css({height: o.dropheight,"padding-top": o.dropheight / 2 - 32}), i.attr({accept: o.accept,multiple: o.multiple}), r.on("click.bfd", function() {
            i.trigger("click")
        });
        var d = [], l = [], c = function(a) {
            var n, i, r = new FileReader;
            l.push(r), r.onloadstart = function() {
            ...
            n = e(".progress-bar", s), e(".bfd-remove", s).tooltip({container: "body",html: !0,placement: "top",title: o.removeMessage}).on("click.bfd", function() {
                r.abort();
                var e = d.indexOf(a);
    ...
    }, e.FileDialog.defaults = {accept: "*",cancelButton: "Close",dragMessage: "Drop files here",dropheight: 400,errorMessage: "An error occured while loading file",multiple: !0,okButton: "OK",readAs: "DataURL",removeMessage: "Remove&nbsp;file",title: "Load file(s)"}
}(jQuery);
